...
Das Titelgebende Objekt, der Spiegel ist ein wichtiger Bestandteil meines Filmes.
Die verschiedenen Handlungszüge vor dem Spiegel zeigen das Hauptproblem der Figur auf.
Ausserdem dient der Spiegel als Reflektor der Gefühle und auch der falschen Wahrnehmung der Figur. 

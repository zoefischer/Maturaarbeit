...
Adrian Flückiger's Film _What's Next_ <<flückiger>> handelt von einem Jungen, der einen anderen jungen Bub an einen Stuhl fesselt, ihm den Mund verbindet und ein Erpresservideo machen will.
...
Um Gefühle und Ausdrücke der Figuren zu zeigen, arbeitet Flückiger intensiv mit dem Ton und Geräuschen.
...
Es scheint als hätte Flückiger gewollt ein einzelnes Licht auf das Opfer gerichtet, damit diese im Fokus steht, während der Täter dadurch eher dunkel wirkt.
...
Doch es zeigte sich, dass meine Vorstellungen weit über meiner zeitlichen Kapazität lagen und sich nciht im Rahmen dieser Maturitätsarbeit realisieren liessen.

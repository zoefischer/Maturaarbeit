...
Nur die Augen können sich bewegen und dienen somit als einzige Möglichkeit für Mimik.
...
Es scheint als hätte Flückiger gewollt ein einzelnes Licht auf das Opfer gerichtet, damit diese im Fokus steht, während der Täter durch das eher dunkel wirkt.
...
Doch es zeigte sich, dass meine Vorstellungen weit über meiner zeitlichen Kapazität lagen und im Rahmen dieser Maturitätsarbeit sich nicht realisieren liessen.

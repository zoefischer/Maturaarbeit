...
Dabei skizziert man grob auf einem Blatt Papier jede Szene und Kameraeinstellung.
...
Dies bedingt für eine gute Standhaftigkeit eine genug dicke und schwere Basis.
Ausserdem ist es schwierig Objekte herzustellen, die transparent, weich oder flüssig sind.
Ich habe mich damit herausgefordert ein Objekt herzustellen, welches aus verschiedenen Materialien und Strukturen besteht und damit an die Grenzen der Möglichkeiten der Knetmasse kommt.
...
Abbildung 6 zeigt meinen Versuch ein Feuers nachzubilden.
...
Ich erkannte, dass es zu zeitaufwendig und ungenau ist, einzelne Fotos zu schiessen und diese dann manuell nacheinander abzuspielen.
...
Der erste Versuch war mit der heruntergeladenen App _StopMotion Studio_ auf meinem iPhone.
...
Dabei verschob sich der ganze Aufbau und das resultierende Video war unruhig und wackelig.
...
Da die Resultate endlich überzeugten und alles funktionierte, entschied ich mich, lieber Geld in ein gut funktionierendes Programm zu investieren, um nicht weitere Zeit zu verlieren.
...
Durch das Verwenden des Teleobjektivs war es mir möglich, sowohl Nahaufnahmen als auch Totale zu verwenden, um unterschiedliche Bildausschnitte zu zeigen.
...
Die Musik, die ich für Vorspann und Abspann gewählt habe, habe ich von der Webseite _Magnatunes_ genommen.

...
Diese habe ich ebenfalls als Clips in "Lightworks" importiert und an passender Stelle platziert.

.Zeitachse in Lightworks
image::images/lwks.png[Zeitachse in Lightworks, pdfwidth=33%,align=center]
